...
Canonical reading list for Part 8 — Linux Kernel Fundamentals.
...
| Part 7 [resources/part-07.md](part-07.md) | Syscall trace baseline |
...
| 8.4 | Love Ch. 4–6, ftrace.rst, Part 6 Projects 35–36 |
...
Boot template: [labs/part-08/scripts/qemu-boot-test.sh.template](../labs/part-08/scripts/qemu-boot-test.sh.template)
...
Part 9 introduces **loadable kernel modules** and character devices. Complete [Part 8 exit gate](../part-08-linux-kernel-fundamentals/README.md#part-exit-gate) first:
...
Do not load out-of-tree modules until Part 9 Module 9.1.

Next: [resources/part-09.md](part-09.md) — loadable modules and driver projects.
