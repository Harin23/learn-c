...
Canonical reading list for Part 9 — Kernel Modules and Drivers.

## Pinned Kernel Version

Use the **same tag** as Part 8 ([resources/part-08.md](part-08.md)):
...
cd labs/part-09/hello-lkm   # or your project dir
make
...
| Part 8 [resources/part-08.md](part-08.md) | VM boot baseline |
...
Part 10 explores DRM and AMDGPU. Complete [Part 9 exit gate](../part-09-kernel-modules-drivers/README.md#part-exit-gate):
...
Do not start AMDGPU code reading until Part 10.

Next: [resources/part-10.md](part-10.md) — graphics stack and AMDGPU analysis.
