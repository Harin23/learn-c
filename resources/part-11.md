...
Canonical reading list for Part 11 — Open Source Contributions (curriculum finale).

## Pinned Kernel Version

Use the same tag as Parts 8–10 ([resources/part-08.md](part-08.md)):
...
Must align with `AMDGPU_TRACE.md` Part 11 preview. **No functional amdgpu driver logic changes.**
...
## Prior Part Cross-Links

| Part | Skill reused in Part 11 |
|-------|--------------------------|
| 7 | `git format-patch`, patch self-review |
| 8 | checkpatch, Signed-off-by, in-tree patch discipline |
| 9 | Driver context for traced files |
| 10 | `AMDGPU_TRACE.md`, Part 11 preview section |

## Curriculum Completion

Complete [Part 11 exit gate](../part-11-open-source-contributions/README.md#part-exit-gate):

- Module reports + Project 52 Part B
- [curriculum-completion-checklist.md](../labs/part-11/checklists/curriculum-completion-checklist.md)
- Part 11 oral checklist
