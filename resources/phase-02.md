...
Canonical reading list for Phase 2 — Memory and Core C.
...
## Gate to Phase 3 / Phase 4

Both Phase 3 (data structures) and Phase 4 (Linux user-space) require Phase 2 exit criteria. Phase 4 specifically requires pointer and malloc fluency — do not skip this phase.
