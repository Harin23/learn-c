...
Canonical reading list for Phase 4 — Linux User-Space Development.
...
Phase 5 introduces `fork`, `exec`, pipes between processes, and networking. Phase 4 exit gate ensures you can read `/proc`, handle signals, use threads, and build with Make/libraries before those syscalls.
