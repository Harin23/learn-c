...
Canonical reading list for Part 3 — Data Structures and Algorithms.
...
| Your project | Linux analogue (Part 7+) |
|--------------|---------------------------|
...
Part 4 (Linux user-space) requires Part 2 exit gate; completing Part 3 first is strongly recommended so file I/O and process tools can use your ADT skills. Part 3 exit gate must pass before treating yourself as ready for systems programming at scale.
