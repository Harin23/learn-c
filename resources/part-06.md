...
Canonical reading list for Part 6 — Computer Architecture and Operating Systems.
...
## Kernel Documentation (Preview for Part 7–8)
...
Part 8 (kernel development) assumes you understand virtual memory, scheduling, and filesystem path lookup. Complete Part 7 (reading code) in parallel or before Part 8.
