...
Starter: [labs/phase-02/fn_ptr_calc_starter.c](../../labs/phase-02/fn_ptr_calc_starter.c)
...
**Callback-Based Menu** — See [projects/phase-02/11-callback-menu.md](../../projects/phase-02/11-callback-menu.md).
...
| Linux kernel function pointers | Skim `include/linux/` patterns in Phase 7 |
