...
Master pointers, dynamic memory, memory layout, function pointers, error handling, and memory debugging. This phase is required before Linux user-space development (Phase 4) and data structures (Phase 3).
...
Complete the [Phase 1 exit gate](../phase-01-programming-foundations/README.md#phase-exit-gate) before starting.
...
Do not start Phase 3 or Phase 4 until you can independently:
...
- Complete the **Phase 2 capstone**: stretchy buffer library with tests ([project spec](../projects/phase-02/09-dynamic-array.md)) plus Valgrind-clean submission

## Resources

See [resources/phase-02.md](../resources/phase-02.md) for the canonical reading list.

## Projects in This Phase

| # | Project | Module | Spec |
|---|---------|--------|------|
| 8 | Pointer toolkit (swap, reverse) | 2.1 | [08-pointer-toolkit.md](../projects/phase-02/08-pointer-toolkit.md) |
