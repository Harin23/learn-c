...
Starter: [labs/phase-02/grow_array_starter.c](../../labs/phase-02/grow_array_starter.c)
...
**Dynamic Array (Stretchy Buffer)** — See [projects/phase-02/09-dynamic-array.md](../../projects/phase-02/09-dynamic-array.md).

This project carries into Phase 3 as a foundation for linked lists and other structures.
