...
- Map the Linux driver model: char/block drivers, major/minor numbers (preview Phase 9)
- Read `/proc/interrupts` and `/sys/class` at a surface level
- Complete Phase 6 with integrated hardware–software mental model
...
## Mini-Project (Phase 6 Capstone)

**Cache and Interrupt Analysis** — [projects/phase-06/38-cache-interrupt-analysis.md](../../projects/phase-06/38-cache-interrupt-analysis.md)

## Phase 6 Oral Checklist (Self-Assessment)
...
6. How does Phase 5 `read()` relate to the page cache?

## Exit Criteria

Before advancing to Phase 8 (after Phase 7), confirm:
...
- [ ] Phase 6 oral checklist completed confidently
- [ ] [Phase 6 exit gate](../README.md#phase-exit-gate) fully satisfied

## Next Phase

[Phase 7 — Reading Large Codebases](../../phase-07-reading-large-codebases/) (coming soon) — can run in parallel if not yet complete.

[Phase 8 — Linux Kernel Fundamentals](../../phase-08-linux-kernel-fundamentals/) requires Phase 6 + Phase 7.
