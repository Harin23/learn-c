...
Starter: [labs/phase-06/pagesize_starter.c](../../labs/phase-06/pagesize_starter.c)

### Lab 2: Parse `/proc/self/maps`

Print each region: address range, permissions, offset, pathname.

Starter: [labs/phase-06/maps_parser_starter.c](../../labs/phase-06/maps_parser_starter.c)

### Lab 3: mmap Anonymous Region

Allocate 1 MiB with `mmap`; touch every page; observe RSS in `/proc/self/status` VmRSS.

Starter: [labs/phase-06/mmap_touch_starter.c](../../labs/phase-06/mmap_touch_starter.c)

### Lab 4: strace mmap/munmap

Trace `mmap`/`munmap`/`brk` during malloc-heavy program (Phase 2 darray).

## Mini-Project

**Virtual Memory Map Explorer** — [projects/phase-06/35-vm-map-explorer.md](../../projects/phase-06/35-vm-map-explorer.md)
