...
- Browse kernel source online or locally without building (building is Phase 8)

## Prerequisites

- Completed [Module 7.1](../module-07-01-navigating-repos/README.md) exit criteria
- Phase 6 virtual memory and filesystem modules strongly recommended
...
Worksheet: [labs/phase-07/worksheets/7.2-kernel-tree-tour.md](../../labs/phase-07/worksheets/7.2-kernel-tree-tour.md)
...
**Kernel Subsystem Trace** — [projects/phase-07/40-kernel-subsystem-trace.md](../../projects/phase-07/40-kernel-subsystem-trace.md)
