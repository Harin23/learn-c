...
- Complete the Part 1 capstone project
...
Location: [labs/part-01/buggy_calc/](../../labs/part-01/buggy_calc/)

Build and debug:

```bash
cd labs/part-01/buggy_calc
make
gdb ./calc
```
...
Reference: [resources/part-01.md](../../resources/part-01.md) — Pro Git chapters 1–3

## Mini-Project

### Part 1 Capstone — Student Gradebook CLI

See [projects/part-01/07-gradebook-capstone.md](../../projects/part-01/07-gradebook-capstone.md).

This is the culminating Part 1 project. Requirements include multi-file layout, Makefile, CSV persistence, GDB use during development, and a Git history with at least five meaningful commits.
...
| Valgrind | Mentioned here; required in Part 2.5 |

## Part 1 Oral Checklist (Self-Assessment)
...
If you hesitate on more than one question, review the relevant module before starting Part 2.

## Exit Criteria

Before advancing to Part 2, confirm:
...
- [ ] Part 1 oral checklist completed confidently
- [ ] [Part 1 exit gate](../README.md#part-exit-gate) fully satisfied

## Next Part

[Part 2 — Memory and Core C](../../part-02-memory-core-c/) (content coming soon)
