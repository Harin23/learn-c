...
2. **Array decay** — arrays pass to functions as pointers (deep dive in Part 2.1)
...
7. **Struct layout** — padding exists (details in Part 6); keep structs simple for now
...
Starter: [labs/part-01/reverse_string_starter.c](../../labs/part-01/reverse_string_starter.c)
...
Test data: [labs/part-01/sample_contacts.csv](../../labs/part-01/sample_contacts.csv)
...
See [projects/part-01/05-contact-card-manager.md](../../projects/part-01/05-contact-card-manager.md).

### Word Counter CLI

See [projects/part-01/06-word-counter.md](../../projects/part-01/06-word-counter.md).
...
| `man 7 signal` | Skim for Part 4 context |
