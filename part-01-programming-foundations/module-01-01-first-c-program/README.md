...
8. **Coding style** — consistent naming; note that the Linux kernel uses tabs (you may use spaces in Part 1)

## Hands-On Labs

### Lab 1: Toolchain Verification

1. Run `scripts/verify-part-01.sh` from the repository root.
...
**Unit Converter CLI** — See [projects/part-01/01-unit-converter.md](../../projects/part-01/01-unit-converter.md).
