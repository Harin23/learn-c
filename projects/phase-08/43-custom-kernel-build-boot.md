...
- [vm-safety-checklist.md](../../labs/phase-08/checklists/vm-safety-checklist.md) completed
- [resources/phase-08.md](../../resources/phase-08.md) pinned kernel tag
- Worksheet [8.2-kbuild-tour.md](../../labs/phase-08/worksheets/8.2-kbuild-tour.md)
...
2. `make defconfig`
3. Merge [learn-c-base.config](../../labs/phase-08/configs/learn-c-base.config):
...
6. Boot in VM using [qemu-boot-test.sh.template](../../labs/phase-08/scripts/qemu-boot-test.sh.template) (copy and customize)
...
[labs/phase-08/worksheets/8.2-kbuild-tour.md](../../labs/phase-08/worksheets/8.2-kbuild-tour.md)

## Template

[labs/phase-08/scripts/qemu-boot-test.sh.template](../../labs/phase-08/scripts/qemu-boot-test.sh.template)
