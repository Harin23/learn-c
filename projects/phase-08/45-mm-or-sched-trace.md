...
Capture live kernel behavior with ftrace (or trace-cmd) and write a report connecting observations to Phase 6 theory and kernel source. Choose **one** track.

## Track A — Scheduling (recommended if Phase 6 Project 36 fresh)

1. Boot your custom kernel VM with debugfs/ftrace enabled ([learn-c-base.config](../../labs/phase-08/configs/learn-c-base.config))
2. Enable `sched:sched_switch` tracepoint
3. Run workload: busy loop, `stress-ng --cpu 2`, or Phase 5 thread-pool binary
...
1. Run a user program that `mmap`s anonymous memory (Phase 6 [mmap_touch_starter.c](../../labs/phase-06/mmap_touch_starter.c))
...
| Concept (Phase 6) | Kernel function | File path |
|-------------------|-----------------|-----------|

Minimum **6 rows**.

### 5. Phase 6 comparison

Compare to [Project 35](../../projects/phase-06/35-vm-map-explorer.md) or [Project 36](../../projects/phase-06/36-scheduler-simulator.md): what user-space tools showed vs what kernel trace shows.
...
| Phase 6 comparison | 15 |
| Worksheet 8.4 completed | 10 |
| **Total** | **100** |

## Worksheet

[labs/phase-08/worksheets/8.4-mm-sched-kernel-tour.md](../../labs/phase-08/worksheets/8.4-mm-sched-kernel-tour.md)
