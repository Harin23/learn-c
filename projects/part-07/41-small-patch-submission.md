# Project 41: Small Patch Submission (Part 7 Capstone)
...
Repository: [labs/part-07/mini-util/](../../labs/part-07/mini-util/)

1. Read [ISSUES.md](../../labs/part-07/mini-util/ISSUES.md)
...
- Your own Part 1–6 project README improvement in learn-c (meta)
...
2. **PATCH_NOTES.md** containing:
   ...
   - Self-review using [patch-review-checklist.md](../../labs/part-07/checklists/patch-review-checklist.md)
...
Projects 39–41 complete Part 7. Part 8 requires Part 6 + Part 7.
