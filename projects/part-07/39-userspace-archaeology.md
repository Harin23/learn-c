...
**Alternative:** [mini-util](../../labs/part-07/mini-util/) `mu-wc` if bandwidth/time limited — note in report.
...
Start with [7.1-mini-util-orientation.md](../../labs/part-07/worksheets/7.1-mini-util-orientation.md) for practice.
