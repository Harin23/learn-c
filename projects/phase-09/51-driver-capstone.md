# Project 51: Phase 9 Driver Capstone
...
Integrated loadable module combining character device I/O, sysfs statistics/tunables, and background updates via kernel timer or workqueue. This is the Phase 9 capstone.
...
7. [lkm-review-checklist.md](../../labs/phase-09/checklists/lkm-review-checklist.md) completed
...
Projects 47–51 complete Phase 9. Phase 10 requires [Phase 9 exit gate](../../phase-09-kernel-modules-drivers/README.md#phase-exit-gate).

## Oral checklist

Complete [Module 9.5 oral checklist](../../phase-09-kernel-modules-drivers/module-09-05-hardware-interfaces/README.md#phase-9-oral-checklist-self-assessment).

## Worksheet

[9.5-irq-mmio-scavenger.md](../../labs/phase-09/worksheets/9.5-irq-mmio-scavenger.md)
