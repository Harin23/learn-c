...
Extend your Project 48 char device module (or rebuild from [sysfs-stats starter](../../labs/phase-09/sysfs-stats/)) to expose read-only statistics and one read-write tunable via sysfs.
...
[9.3-sysfs-tour.md](../../labs/phase-09/worksheets/9.3-sysfs-tour.md)
