...
- `$KERNEL_SRC` or Elixir at pinned tag ([resources/phase-10.md](../../resources/phase-10.md))
- Worksheet [10.2-drm-amdgpu-tree.md](../../labs/phase-10/worksheets/10.2-drm-amdgpu-tree.md)
...
Two paragraphs: DRM file ops vs regular file read path (Phase 7 Project 40).
