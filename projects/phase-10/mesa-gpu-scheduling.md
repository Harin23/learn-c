...
Explain Mesa's role in the graphics stack, outline its AMD-related source layout, and compare CPU scheduling (Phase 6) to GPU command submission at a high level.

## Prerequisites

- Completed `DRM_AMDGPU_WALK.md` or in progress
- Worksheet [10.3-mesa-scheduling.md](../../labs/phase-10/worksheets/10.3-mesa-scheduling.md)
...
Compare Phase 6 scheduler simulator / CFS concepts to GPU queue scheduling — what is similar, what differs.
...
| GPU scheduling + Phase 6 comparison | 20 |
...
- Submit patches to Mesa in this report (Phase 11)
