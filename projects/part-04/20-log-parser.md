...
Test file: [labs/part-04/testdata/sample.log](../../labs/part-04/testdata/sample.log)
...
- Use your Part 3 hash map optionally for `--top-hosts`
...
Parse one line in [labs/part-04/log_parse_starter.c](../../labs/part-04/log_parse_starter.c)
