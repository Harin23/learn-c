...
- Worksheet [10.1-graphics-stack-tour.md](../../labs/part-10/worksheets/10.1-graphics-stack-tour.md)
...
One paragraph each linking to Part 6 (`/sys/class/drm`) and Part 9 (PCI/display driver binding).
