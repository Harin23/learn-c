...
**Curriculum project:** 52 (Part A of 2 — Part B in Part 11)  
**Estimated time:** 12–16 hours

## Description

Trace one AMDGPU-related path through userspace (optional) and kernel DRM/amdgpu code. Document file paths and function names — **read-only**, like Part 7 Project 40 but focused on the graphics stack.

Part B (Part 11) will use this trace to inform a small upstream documentation or code contribution.
...
| Part 11 preview | 10 |
| [graphics-trace-checklist.md](../../labs/part-10/checklists/graphics-trace-checklist.md) completed | 10 |
| Worksheet 10.4 completed | 5 |
| **Total** | **100** |

## Checklist

[labs/part-10/checklists/graphics-trace-checklist.md](../../labs/part-10/checklists/graphics-trace-checklist.md)
...
Part 11 — [Project 52 Part B](../part-11/52-amdgpu-contribution-part-b.md)
