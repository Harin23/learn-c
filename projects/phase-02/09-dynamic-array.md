...
Implement a generic-ish dynamic array of `int` values that grows automatically. This structure is reused throughout Phase 3.
...
Optional: [labs/phase-02/darray_starter/](../../labs/phase-02/darray_starter/)
