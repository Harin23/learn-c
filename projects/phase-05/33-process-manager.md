# Project 33: Process Manager (Phase 5 Capstone)
...
| Command | Action |
|---------|--------|
| `list` | Print PID, STAT, CMD from `/proc` (reuse Phase 4 procview logic) |
...
Passing this project (≥80 points) plus Projects 27–32 completes Phase 5.

## Starter

Combine [proc_stat_starter.c](../../labs/phase-04/proc_stat_starter.c) patterns with [fork_starter.c](../../labs/phase-05/fork_starter.c)
