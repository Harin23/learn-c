# Project 26: Static + Shared Library Demo (Phase 4 Capstone)
...
Extract a utility library from your Phase 4 work; build as `.a` and `.so`; link two demo programs against each.
...
[labs/phase-04/lib_demo/](../../labs/phase-04/lib_demo/)

## Phase 4 Completion

Passing this project (≥80 points) plus Projects 19–25 completes Phase 4.
