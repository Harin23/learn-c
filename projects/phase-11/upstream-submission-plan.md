...
Plan your Project 52 Part B contribution: identify MAINTAINERS routing, draft a cover letter, and choose a safe doc/comment target informed by your Phase 10 `AMDGPU_TRACE.md`.

## Prerequisites

- Worksheet [11.2-upstream-submission-plan.md](../../labs/phase-11/worksheets/11.2-upstream-submission-plan.md)
- Completed `AMDGPU_TRACE.md` (Project 52 Part A) with Phase 11 preview section
...
- Paste Phase 11 preview summary from `AMDGPU_TRACE.md` (2–3 sentences)
...
[Module 11.3 — Upstream Development and Git Workflows](../../phase-11-open-source-contributions/module-11-03-upstream-development-git-workflows/README.md)
