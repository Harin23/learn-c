...
- Part 7 Project 40 notes (syscall trace) for comparison
- Worksheet [8.1-boot-log-analysis.md](../../labs/part-08/worksheets/8.1-boot-log-analysis.md)
...
| Part | Approx. time / order | Example messages |
|-------|----------------------|------------------|
...
Two paragraphs: how boot-time init relates to the runtime syscall path you traced in Part 7.
...
[labs/part-08/worksheets/8.1-boot-log-analysis.md](../../labs/part-08/worksheets/8.1-boot-log-analysis.md)
