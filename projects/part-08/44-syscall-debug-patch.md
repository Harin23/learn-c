...
Add minimal, guarded debug instrumentation on the syscall path you traced in Part 7 Project 40. Rebuild the kernel, boot in VM, trigger the syscall, and confirm output in `dmesg`.
...
3. Completed [kernel-patch-review-checklist.md](../../labs/part-08/checklists/kernel-patch-review-checklist.md) (paste checklist with checkmarks)
...
[labs/part-08/worksheets/8.3-coding-style-lab.md](../../labs/part-08/worksheets/8.3-coding-style-lab.md)

## Do not

- Add loadable modules (Part 9)
