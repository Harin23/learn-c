# Project 46: Part 8 Capstone — Tested In-Tree Kernel Patch
...
Deliver a polished, boot-tested in-tree kernel patch series that demonstrates Part 8 skills: build system, coding style, locking awareness, and VM validation. This is the Part 8 capstone.
...
6. [kernel-patch-review-checklist.md](../../labs/part-08/checklists/kernel-patch-review-checklist.md) completed
7. [vm-safety-checklist.md](../../labs/part-08/checklists/vm-safety-checklist.md) if booting new image
...
Projects 42–46 complete Part 8. Part 9 requires [Part 8 exit gate](../../part-08-linux-kernel-fundamentals/README.md#part-exit-gate).

## Worksheet

[labs/part-08/worksheets/8.5-locking-scavenger-hunt.md](../../labs/part-08/worksheets/8.5-locking-scavenger-hunt.md)

## Oral checklist

Complete [Module 8.5 oral checklist](../../part-08-linux-kernel-fundamentals/module-08-05-kernel-synchronization/README.md#part-8-oral-checklist-self-assessment) before advancing.
