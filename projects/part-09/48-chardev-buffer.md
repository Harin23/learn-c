...
- Module 9.1 complete
- Starter: [labs/part-09/chardev-buffer/](../../labs/part-09/chardev-buffer/)
- Test tools: [test_read.c](../../labs/part-09/user-tools/test_read.c), [test_write.c](../../labs/part-09/user-tools/test_write.c)
...
[9.2-chardev-walkthrough.md](../../labs/part-09/worksheets/9.2-chardev-walkthrough.md)
