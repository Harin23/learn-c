...
- [labs/part-09/hello-lkm/](../../labs/part-09/hello-lkm/) completed or used as base
- Worksheet [9.1-lkm-build-load.md](../../labs/part-09/worksheets/9.1-lkm-build-load.md)
...
[module-vm-safety-checklist.md](../../labs/part-09/checklists/module-vm-safety-checklist.md) — VM only.
