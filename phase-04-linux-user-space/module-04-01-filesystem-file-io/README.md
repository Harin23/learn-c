...
- [Phase 2 exit gate](../../phase-02-memory-core-c/README.md#phase-exit-gate)
- Phase 3 recommended
...
Starter: [labs/phase-04/copy_starter.c](../../labs/phase-04/copy_starter.c)

### Lab 2: Directory Listing

List files in a directory with type and size from `stat`.

Starter: [labs/phase-04/listdir_starter.c](../../labs/phase-04/listdir_starter.c)
...
1. **mycat** — [projects/phase-04/19-mycat.md](../../projects/phase-04/19-mycat.md)
2. **Log parser** — [projects/phase-04/20-log-parser.md](../../projects/phase-04/20-log-parser.md)
3. **File organizer** — [projects/phase-04/21-file-organizer.md](../../projects/phase-04/21-file-organizer.md)

Sample log: [labs/phase-04/testdata/sample.log](../../labs/phase-04/testdata/sample.log)
