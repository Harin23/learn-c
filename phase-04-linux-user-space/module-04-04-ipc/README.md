...
- Use anonymous pipes for parent-child communication (preview of Phase 5)
...
8. **Phase 5 preview** — `fork` + pipe patterns coming next
...
Starter: [labs/phase-04/pipe_starter.c](../../labs/phase-04/pipe_starter.c)

### Lab 2: Shared Memory Counter

Two processes or two threads mapping same shm — increment with semaphore protection.

Starter: [labs/phase-04/shm_starter/](../../labs/phase-04/shm_starter/)
...
**Producer-Consumer (IPC)** — [projects/phase-04/25-producer-consumer.md](../../projects/phase-04/25-producer-consumer.md)
