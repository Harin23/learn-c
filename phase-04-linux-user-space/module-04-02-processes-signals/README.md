...
8. **Preview** — `fork`/`exec` deferred to Phase 5
...
Starter: [labs/phase-04/proc_self_starter.c](../../labs/phase-04/proc_self_starter.c)

### Lab 2: Parse `/proc/[pid]/stat`

Extract process state character and utime/stime fields (man `proc(5)` field order).

Starter: [labs/phase-04/proc_stat_starter.c](../../labs/phase-04/proc_stat_starter.c)

### Lab 3: SIGINT Handler

Count Ctrl+C presses; quit on third SIGINT. Use `sigaction` with `SA_RESTART` discussion.

Starter: [labs/phase-04/signal_starter.c](../../labs/phase-04/signal_starter.c)
...
1. **Process viewer** — [projects/phase-04/22-process-viewer.md](../../projects/phase-04/22-process-viewer.md)
2. **System monitor** — [projects/phase-04/23-system-monitor.md](../../projects/phase-04/23-system-monitor.md)
