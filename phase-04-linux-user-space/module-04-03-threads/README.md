...
Starter: [labs/phase-04/pthread_hello_starter.c](../../labs/phase-04/pthread_hello_starter.c)

### Lab 2: Race Condition Demo

Increment shared counter from multiple threads without mutex — observe wrong total. Fix with mutex.

Starter: [labs/phase-04/pthread_counter_starter.c](../../labs/phase-04/pthread_counter_starter.c)
...
**Mini Text Editor** — [projects/phase-04/24-mini-text-editor.md](../../projects/phase-04/24-mini-text-editor.md)
