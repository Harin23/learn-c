...
Worksheet: [labs/phase-09/worksheets/9.4-pci-driver-trace.md](../../labs/phase-09/worksheets/9.4-pci-driver-trace.md)

Trace one bound device to in-tree driver source file.

### Lab 3: pci-skeleton Module

Build and load [labs/phase-09/pci-skeleton/](../../labs/phase-09/pci-skeleton/) in VM. Confirm registration in `dmesg`; zero probes is acceptable.
...
**PCI Driver Architecture Lab** — [projects/phase-09/50-pci-driver-architecture.md](../../projects/phase-09/50-pci-driver-architecture.md)
