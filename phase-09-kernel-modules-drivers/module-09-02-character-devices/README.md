...
- Connect char device path to Phase 6 driver model preview
...
1. **Char vs block devices** — byte-stream vs fixed blocks (Phase 6 review)
...
Worksheet: [labs/phase-09/worksheets/9.2-chardev-walkthrough.md](../../labs/phase-09/worksheets/9.2-chardev-walkthrough.md)

Extend Phase 7 syscall trace with driver `open` callback.

### Lab 3: chardev-buffer Starter

Build [labs/phase-09/chardev-buffer/](../../labs/phase-09/chardev-buffer/); create `/dev` node; test with [test_read.c](../../labs/phase-09/user-tools/test_read.c) and [test_write.c](../../labs/phase-09/user-tools/test_write.c).
...
**Circular Buffer Char Device** — [projects/phase-09/48-chardev-buffer.md](../../projects/phase-09/48-chardev-buffer.md)
...
| Phase 6 [Module 6.5](../../phase-06-computer-architecture-os/module-06-05-drivers-interrupts-caches/README.md) | Char/block preview |
