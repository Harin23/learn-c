...
7. **Phase 8 locking** — no sleep in atomic context; mutex OK in fops
...
Worksheet: [labs/phase-09/worksheets/9.5-irq-mmio-scavenger.md](../../labs/phase-09/worksheets/9.5-irq-mmio-scavenger.md)
...
**Phase 9 Driver Capstone** — [projects/phase-09/51-driver-capstone.md](../../projects/phase-09/51-driver-capstone.md)
...
| Phase 8 [Module 8.5](../../phase-08-linux-kernel-fundamentals/module-08-05-kernel-synchronization/README.md) | Locking review |

## Phase 9 Oral Checklist (Self-Assessment)
...
Before advancing to Phase 10, confirm:
...
- [ ] Phase 9 oral checklist completed confidently
- [ ] [Phase 9 exit gate](../README.md#phase-exit-gate) fully satisfied

## Next Phase

[Phase 10 — AMD Driver and Graphics Stack](../../phase-10-amd-driver-graphics/)

Requires Phase 9 exit gate complete.
