...
- Connect Phase 6 `/sys/class/drm` lab and Phase 9 PCI/display binding concepts

## Prerequisites

- [Phase 9 exit gate](../../phase-09-kernel-modules-drivers/README.md#phase-exit-gate)
- `$KERNEL_SRC` available (same tag as Phase 8/9)

## Concepts to Study

1. **Application** — OpenGL/Vulkan/EGL client
2. **Mesa** — userspace driver implementation (Phase 10.3 deepens)
...
Worksheet: [labs/phase-10/worksheets/10.1-graphics-stack-tour.md](../../labs/phase-10/worksheets/10.1-graphics-stack-tour.md)
...
**Graphics Stack Map** — [projects/phase-10/graphics-stack-map.md](../../projects/phase-10/graphics-stack-map.md)
...
| Resource | Notes |
|----------|-------|
| [resources/phase-10.md](../../resources/phase-10.md) | Reading map |
| `Documentation/gpu/` | Kernel GPU docs index |
| Phase 6 [Module 6.5](../../phase-06-computer-architecture-os/module-06-05-drivers-interrupts-caches/README.md) | `/sys/class` preview |
