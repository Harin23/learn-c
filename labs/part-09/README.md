...
Out-of-tree kernel module starters and worksheets. Kernel source is **not** vendored — set `KERNEL_SRC` to your Part 8 tree.

## Setup

```bash
export KERNEL_SRC="$HOME/src/linux"
./scripts/verify-part-09.sh
```

Before Module 9.1, merge [configs/learn-c-modules.config](configs/learn-c-modules.config) into your Part 8 kernel config and rebuild the VM kernel.
