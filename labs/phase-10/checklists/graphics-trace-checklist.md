# Graphics Trace Checklist — Phase 10

Use before submitting `AMDGPU_TRACE.md` (Project 52 Part A). Extends Phase 7 trace habits.
...
- [ ] References Phase 7 trace format (table + diagram)
- [ ] GEM/TTM mentioned if trace touches memory path
- [ ] Phase 11 preview section names realistic small contribution type
