# Upstream Submission Checklist — Part 11

Use before sending or exporting Project 52 Part B. Extends [Part 8 kernel patch checklist](../../part-08/checklists/kernel-patch-review-checklist.md).

## Trace alignment

- [ ] Patch targets a file or doc section referenced in `AMDGPU_TRACE.md`
- [ ] `CONTRIBUTION_REPORT.md` links to trace step number
- [ ] Scope matches Part 10 preview (no scope creep into driver logic)
