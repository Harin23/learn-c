...
Worksheets, checklists, and practice materials for upstream contribution workflow. This part produces real patches — doc/comment fixes recommended for Project 52 Part B.
...
# configure git send-email — see resources/part-11.md
```
