...
- Verify module activity in `dmesg` inside your Part 8 VM

## Prerequisites

- [Part 8 exit gate](../../part-08-linux-kernel-fundamentals/README.md#part-exit-gate)
- `$KERNEL_SRC` set to the same tree used to build your VM kernel
- Read [module-vm-safety-checklist.md](../../labs/part-09/checklists/module-vm-safety-checklist.md)
...
Merge [labs/part-09/configs/learn-c-modules.config](../../labs/part-09/configs/learn-c-modules.config) into your Part 8 `.config`:

```bash
cd "$KERNEL_SRC"
./scripts/kconfig/merge_config.sh .config /path/to/learn-c/labs/part-09/configs/learn-c-modules.config
make olddefconfig
...
Complete [labs/part-09/hello-lkm/](../../labs/part-09/hello-lkm/) starter; copy `.ko` to VM; `sudo insmod hello_lkm.ko`; check `dmesg`; `sudo rmmod hello_lkm`.

### Lab 4: insmod Path Worksheet

Worksheet: [labs/part-09/worksheets/9.1-lkm-build-load.md](../../labs/part-09/worksheets/9.1-lkm-build-load.md)

## Mini-Project

**Hello LKM with Module Parameter** — [projects/part-09/47-hello-lkm-parameter.md](../../projects/part-09/47-hello-lkm-parameter.md)

## Recommended Resources

| Resource | Notes |
|----------|-------|
| [resources/part-09.md](../../resources/part-09.md) | Build commands |
