...
- Navigate `/sys/class` and `/sys/bus/pci/devices` (Part 6 revisit)
...
Worksheet: [labs/part-09/worksheets/9.3-sysfs-tour.md](../../labs/part-09/worksheets/9.3-sysfs-tour.md)

### Lab 3: Add Stats to Chardev Module

Extend Project 48 (or [sysfs-stats starter](../../labs/part-09/sysfs-stats/)) with `read_count` and `write_count` sysfs files.
...
**Sysfs Monitoring Module** — [projects/part-09/49-sysfs-monitoring-module.md](../../projects/part-09/49-sysfs-monitoring-module.md)
