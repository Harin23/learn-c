...
Starter: [labs/part-05/fork_starter.c](../../labs/part-05/fork_starter.c)

### Lab 2: exec ls

Child runs `execvp("ls", argv)`; parent waits and prints exit code.

Starter: [labs/part-05/exec_starter.c](../../labs/part-05/exec_starter.c)
...
**Custom Shell** — [projects/part-05/27-custom-shell.md](../../projects/part-05/27-custom-shell.md)
