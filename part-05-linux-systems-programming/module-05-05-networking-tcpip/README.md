...
Starter: [labs/part-05/echo_server_starter.c](../../labs/part-05/echo_server_starter.c)

### Lab 2: TCP Client

Connect to echo server; send message; print reply.

Starter: [labs/part-05/echo_client_starter.c](../../labs/part-05/echo_client_starter.c)

### Lab 3: Minimal HTTP Response

Parse `GET /path HTTP/1.1` from buffer; respond with 200 and HTML body.

Starter: [labs/part-05/http_parse_starter.c](../../labs/part-05/http_parse_starter.c)
...
1. **HTTP Server** — [projects/part-05/30-http-server.md](../../projects/part-05/30-http-server.md)
2. **Chat Server** — [projects/part-05/31-chat-server.md](../../projects/part-05/31-chat-server.md)
