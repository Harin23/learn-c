...
Starter: [labs/part-05/pipe_fork_starter.c](../../labs/part-05/pipe_fork_starter.c)

### Lab 2: dup2 Redirect

Redirect stdout to pipe or file; run printf; verify reader receives output.

Starter: [labs/part-05/dup2_starter.c](../../labs/part-05/dup2_starter.c)
...
**Pipe Filter Pipeline** — [projects/part-05/28-pipe-pipeline.md](../../projects/part-05/28-pipe-pipeline.md)
