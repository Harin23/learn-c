...
3. **`epoll(7)` preview** — scalable Linux multiplexing; Part 5 optional extension
...
Starter: [labs/part-05/select_starter.c](../../labs/part-05/select_starter.c)

### Lab 2: inotify Directory Watch

Print events when files created/modified in a directory.

Starter: [labs/part-05/inotify_starter.c](../../labs/part-05/inotify_starter.c)
...
1. **File Watcher** — [projects/part-05/32-file-watcher.md](../../projects/part-05/32-file-watcher.md)
2. **Process Manager** — [projects/part-05/33-process-manager.md](../../projects/part-05/33-process-manager.md)

## Part 5 Oral Checklist (Self-Assessment)
...
Before advancing to Part 6, confirm:
...
- [ ] Part 5 oral checklist completed confidently
- [ ] [Part 5 exit gate](../README.md#part-exit-gate) fully satisfied

## Next Part

[Part 6 — Computer Architecture and OS](../../part-06-computer-architecture-os/) (coming soon)
