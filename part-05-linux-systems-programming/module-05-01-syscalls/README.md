...
- Recognize syscalls used in your Part 4 projects retroactively

## Prerequisites

- Completed [Part 4 exit gate](../../part-04-linux-user-space/README.md#part-exit-gate)
...
5. **Return values** — `-1` on error, `errno` set; same pattern as Part 4
...
Starter: [labs/part-05/errno_starter.c](../../labs/part-05/errno_starter.c)
...
- [ ] Syscall inventory document written for one Part 4 program
