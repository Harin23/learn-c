...
Worksheet: [labs/phase-11/worksheets/11.2-upstream-submission-plan.md](../../labs/phase-11/worksheets/11.2-upstream-submission-plan.md)

## Module Report

**Upstream Submission Plan** — [projects/phase-11/upstream-submission-plan.md](../../projects/phase-11/upstream-submission-plan.md)
...
| Resource | Notes |
|----------|-------|
| [resources/phase-11.md](../../resources/phase-11.md) | Submission tools and lists |
| `Documentation/process/submitting-patches.rst` | Canonical kernel guide |
| [resources/phase-10.md](../../resources/phase-10.md) | Trace context |
