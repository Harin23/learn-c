...
- Complete the curriculum with Phase 11 oral and completion checklists
...
1. **Implementing Phase 10 preview** — scope control, no driver logic changes
...
6. **Curriculum synthesis** — oral checklist spanning Phases 7–11
...
Apply [labs/phase-11/checklists/upstream-submission-checklist.md](../../labs/phase-11/checklists/upstream-submission-checklist.md).
...
Worksheet: [labs/phase-11/worksheets/11.3-contribution-execution.md](../../labs/phase-11/worksheets/11.3-contribution-execution.md)

## Capstone — Project 52 Part B

**AMDGPU Upstream Contribution** — [projects/phase-11/52-amdgpu-contribution-part-b.md](../../projects/phase-11/52-amdgpu-contribution-part-b.md)
...
| Resource | Notes |
|----------|-------|
| [resources/phase-11.md](../../resources/phase-11.md) | Final reading |
| [projects/phase-10/52-amdgpu-trace-part-a.md](../../projects/phase-10/52-amdgpu-trace-part-a.md) | Part A trace |
| [curriculum-completion-checklist.md](../../labs/phase-11/checklists/curriculum-completion-checklist.md) | Final sign-off |

## Phase 11 Oral Checklist (Self-Assessment)
...
6. What did your Part B patch clarify from your Phase 10 trace?
7. When is VM boot required for a kernel patch?
8. Name one graphics stack layer your trace crossed (userspace → kernel).

Cross-check: Phase 7, 8, and 10 oral checklists if any answer was uncertain.
...
- [ ] [upstream-submission-checklist.md](../../labs/phase-11/checklists/upstream-submission-checklist.md) completed
- [ ] [curriculum-completion-checklist.md](../../labs/phase-11/checklists/curriculum-completion-checklist.md) completed
- [ ] Phase 11 oral checklist passed
- [ ] [Phase 11 exit gate](../README.md#phase-exit-gate) fully satisfied

## Curriculum Complete

Congratulations — you have completed all 11 phases and 52 projects of the learn-c curriculum.

See [Phase 11 README](../README.md#curriculum-completion-gate) for continuing after the curriculum.
