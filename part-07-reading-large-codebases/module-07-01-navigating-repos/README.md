...
- [Part 5 exit gate](../../part-05-linux-systems-programming/README.md#part-exit-gate)
...
Run [labs/part-07/scripts/setup-tools.sh](../../labs/part-07/scripts/setup-tools.sh) and verify `rg`, `ctags`, `cscope` work.

### Lab 2: mini-util Orientation

Explore [labs/part-07/mini-util/](../../labs/part-07/mini-util/): build, run tests, generate tags.

Worksheet: [labs/part-07/worksheets/7.1-mini-util-orientation.md](../../labs/part-07/worksheets/7.1-mini-util-orientation.md)
...
**User-Space Codebase Archaeology** — [projects/part-07/39-userspace-archaeology.md](../../projects/part-07/39-userspace-archaeology.md)
