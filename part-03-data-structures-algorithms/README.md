...
Build fundamental data structures in C and develop algorithmic thinking with performance analysis. Structures from this part appear throughout Linux user-space and kernel code.
...
Complete the [Part 2 exit gate](../part-02-memory-core-c/README.md#part-exit-gate) before starting.
...
Do not start Part 4 until you can independently:
...
- Complete the **Part 3 capstone integration**: sort benchmark with written analysis ([project spec](../projects/part-03/18-sort-benchmark.md))

## Resources

See [resources/part-03.md](../resources/part-03.md) for the canonical reading list.

## Projects in This Part

| # | Project | Module | Spec |
|---|---------|--------|------|
| 13 | Singly linked list toolkit | 3.1 | [13-linked-list-toolkit.md](../projects/part-03/13-linked-list-toolkit.md) |
| 14 | RPN calculator (stack) | 3.1 | [14-rpn-calculator.md](../projects/part-03/14-rpn-calculator.md) |
| 15 | Job queue | 3.1 | [15-job-queue.md](../projects/part-03/15-job-queue.md) |
| 16 | Simple hash map | 3.2 | [16-hash-map.md](../projects/part-03/16-hash-map.md) |
| 17 | File-system tree (BST) | 3.3 | [17-bst-filesystem.md](../projects/part-03/17-bst-filesystem.md) |
| 18 | Sort benchmark suite | 3.5 | [18-sort-benchmark.md](../projects/part-03/18-sort-benchmark.md) |
