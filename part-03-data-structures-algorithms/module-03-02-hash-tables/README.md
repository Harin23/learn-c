...
8. **Linux connection** — kernel hash tables, `hlist`, dentry cache (Part 7 preview)
...
Starter: [labs/part-03/hash_fn_starter.c](../../labs/part-03/hash_fn_starter.c)
...
Starter: [labs/part-03/hashmap_starter/](../../labs/part-03/hashmap_starter/)
...
**Simple Hash Map** — [projects/part-03/16-hash-map.md](../../projects/part-03/16-hash-map.md)
