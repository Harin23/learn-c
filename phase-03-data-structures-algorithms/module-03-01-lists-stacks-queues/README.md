...
- Completed [Phase 2 exit gate](../../phase-02-memory-core-c/README.md#phase-exit-gate)
- Dynamic array project ([Project 9](../../projects/phase-02/09-dynamic-array.md)) completed or equivalent
...
Starter: [labs/phase-03/list_starter/](../../labs/phase-03/list_starter/)

### Lab 3: Stack with Linked List Backend

Implement push/pop/peek using a linked list (no array). Verify LIFO order.

Starter: [labs/phase-03/stack_starter/](../../labs/phase-03/stack_starter/)
...
Starter: [labs/phase-03/queue_starter/](../../labs/phase-03/queue_starter/)

## Mini-Projects

Complete all three — they reinforce different ADTs from the same module:

1. **Singly Linked List Toolkit** — [projects/phase-03/13-linked-list-toolkit.md](../../projects/phase-03/13-linked-list-toolkit.md)
2. **RPN Calculator** — [projects/phase-03/14-rpn-calculator.md](../../projects/phase-03/14-rpn-calculator.md)
3. **Job Queue** — [projects/phase-03/15-job-queue.md](../../projects/phase-03/15-job-queue.md)
...
| Linux kernel `list.h` | Preview for Phase 7 — doubly linked lists |
