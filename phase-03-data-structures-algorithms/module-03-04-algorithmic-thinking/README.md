...
Starter: [labs/phase-03/binary_search_starter.c](../../labs/phase-03/binary_search_starter.c)

### Lab 2: Insertion Sort

Implement in-place insertion sort. Trace on paper for `{5, 2, 4, 1}`.

Starter: [labs/phase-03/insertion_sort_starter.c](../../labs/phase-03/insertion_sort_starter.c)
...
Starter: [labs/phase-03/merge_sort_starter/](../../labs/phase-03/merge_sort_starter/)
...
This module has no standalone mini-project. Skills feed directly into [Module 3.5](../module-03-05-performance-analysis/README.md) and [Project 18](../../projects/phase-03/18-sort-benchmark.md).
