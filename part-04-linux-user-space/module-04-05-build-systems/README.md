...
- Basic Makefiles from Part 1–3 projects
...
Starter: [labs/part-04/makefile_lab/](../../labs/part-04/makefile_lab/)
...
| Linux kernel `Documentation/kbuild/` | Part 7 preview |
...
- [ ] At least two Part 4 projects use structured `src/`/`include/` layout
