...
- Map Phase 6 concepts (VM, scheduling, VFS) to kernel top-level directories
- Relate Phase 7 Project 40 syscall trace to architecture entry code in `arch/x86/`

## Prerequisites

- [Phase 6 exit gate](../../phase-06-computer-architecture-os/README.md#phase-exit-gate)
- [Phase 7 exit gate](../../phase-07-reading-large-codebases/README.md#phase-exit-gate)
- Completed Project 40 (kernel subsystem trace) or equivalent notes

## Concepts to Study

1. **Monolithic kernel** — most services in one image; loadable modules (Phase 9 preview)
...
7. **Syscall entry** — revisit `arch/x86/entry/` path from Phase 7
...
Worksheet: [labs/phase-08/worksheets/8.1-boot-log-analysis.md](../../labs/phase-08/worksheets/8.1-boot-log-analysis.md)
...
**Kernel Boot Log Analysis** — [projects/phase-08/42-kernel-boot-log-analysis.md](../../projects/phase-08/42-kernel-boot-log-analysis.md)

## Recommended Resources

| Resource | Notes |
|----------|-------|
| [resources/phase-08.md](../../resources/phase-08.md) | Pinned kernel version |
| *Linux Kernel Development* (Love) Ch. 2 | Boot and architecture overview |
| `Documentation/admin-guide/README.rst` | Kernel docs index |
| Phase 7 [Project 40](../../projects/phase-07/40-kernel-subsystem-trace.md) | Syscall trace baseline |
