...
Fix deliberately bad patch hunks in [labs/phase-08/worksheets/8.3-coding-style-lab.md](../../labs/phase-08/worksheets/8.3-coding-style-lab.md) (paper exercise; no compile required).

### Lab 2: Add Guarded Debug Printk

Add a one-line `pr_debug` or `printk(KERN_DEBUG ...)` on the syscall path you traced in Phase 7 (e.g. near `vfs_read`). Guard with `#ifdef CONFIG_DEBUG_FS` or a local `CONFIG_LEARN_C_DEBUG` if you add a Kconfig snippet (optional advanced).
...
Apply [kernel-patch-review-checklist.md](../../labs/phase-08/checklists/kernel-patch-review-checklist.md) before exporting:
...
**Syscall Debug Patch** — [projects/phase-08/44-syscall-debug-patch.md](../../projects/phase-08/44-syscall-debug-patch.md)
...
| Phase 7 [patch checklist](../../labs/phase-07/checklists/patch-review-checklist.md) | User-space baseline |
