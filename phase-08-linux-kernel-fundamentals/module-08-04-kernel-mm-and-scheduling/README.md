...
- Connect Phase 6 virtual memory concepts to `mm/` implementation
- Describe page allocator and SLUB at a conceptual level
- Relate Phase 6 scheduler simulation to CFS in `kernel/sched/`
...
- Phase 6 [Module 6.2](../../phase-06-computer-architecture-os/module-06-02-virtual-memory/README.md) and [Module 6.3](../../phase-06-computer-architecture-os/module-06-03-scheduling/README.md) review recommended
...
8. **User vs kernel observation** — `/proc`, `ftrace`, Phase 6 simulators

## Hands-On Labs

### Lab 1: MM and Sched Source Tour

Worksheet: [labs/phase-08/worksheets/8.4-mm-sched-kernel-tour.md](../../labs/phase-08/worksheets/8.4-mm-sched-kernel-tour.md)

Locate functions related to Phase 6 Projects 35 and 36 in the kernel tree.
...
# run busy loop or Phase 5 thread-pool workload in another terminal
...
Two paragraphs: what Phase 6 round-robin simulator captures that CFS does differently (qualitative; no formula proof required).

## Mini-Project

**MM or Scheduler Live Trace Report** — [projects/phase-08/45-mm-or-sched-trace.md](../../projects/phase-08/45-mm-or-sched-trace.md)
...
| Phase 6 [Project 35](../../projects/phase-06/35-vm-map-explorer.md), [Project 36](../../projects/phase-06/36-scheduler-simulator.md) | User-space baseline |
...
- [ ] Explicit connection to Phase 6 concepts in written comparison
