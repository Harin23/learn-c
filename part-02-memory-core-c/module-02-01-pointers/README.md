...
- Completed [Part 1 exit gate](../../part-01-programming-foundations/README.md#part-exit-gate)
- Comfortable with arrays, strings, and functions from Part 1
...
5. **Pass-by-value vs pass-by-pointer** — why Part 1 `swap` failed; fix with `int *`
...
Starter: [labs/part-02/pointer_basics_starter.c](../../labs/part-02/pointer_basics_starter.c)

### Lab 2: Fix the Swap

Implement `void swap(int *a, int *b)` that exchanges values in caller variables. Verify with GDB that caller variables change.

Starter: [labs/part-02/swap_starter.c](../../labs/part-02/swap_starter.c)
...
**Pointer Toolkit** — See [projects/part-02/08-pointer-toolkit.md](../../projects/part-02/08-pointer-toolkit.md).
