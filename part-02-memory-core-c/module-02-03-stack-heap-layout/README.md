...
8. **Alignment and padding** — structs may have gaps (ties to Part 6)
...
Starter: [labs/part-02/memory_addresses_starter.c](../../labs/part-02/memory_addresses_starter.c)
...
**Stack Frame Visualizer** — See [projects/part-02/10-stack-visualizer.md](../../projects/part-02/10-stack-visualizer.md).
...
| Part 6 preview — virtual memory | Skim roadmap only |
