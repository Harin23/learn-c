...
- Submit a Valgrind-clean Part 2 portfolio
...
See [projects/part-02/12-valgrind-fix.md](../../projects/part-02/12-valgrind-fix.md) for rubric.
...
Starter discussion in [labs/part-02/buffer_overflow_demo.c](../../labs/part-02/buffer_overflow_demo.c)

### Lab 4: Pitfalls Checklist

Write a one-page `PITFALLS.md` in your project directory documenting five pitfalls you encountered in Part 2 and how you fixed each.

## Mini-Project

**Fix Memory Leaks with Valgrind** — See [projects/part-02/12-valgrind-fix.md](../../projects/part-02/12-valgrind-fix.md).
...
## Part 2 Oral Checklist (Self-Assessment)
...
Before advancing to Part 3 or Part 4, confirm:
...
- [ ] Part 2 oral checklist completed confidently
- [ ] [Part 2 exit gate](../README.md#part-exit-gate) fully satisfied

## Next Part

- [Part 3 — Data Structures and Algorithms](../../part-03-data-structures-algorithms/) (coming soon)
- [Part 4 — Linux User-Space Development](../../part-04-linux-user-space/) requires Part 2 exit gate
