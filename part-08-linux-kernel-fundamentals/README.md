...
Build, boot, observe, and patch the Linux kernel in-tree. This part bridges Part 7 (read-only kernel navigation) and Part 9 (loadable kernel modules and drivers).
...
**Required:** [Part 6 exit gate](../part-06-computer-architecture-os/README.md#part-exit-gate)

**Required:** [Part 7 exit gate](../part-07-reading-large-codebases/README.md#part-exit-gate)
...
See [docs/environment-setup.md](../docs/environment-setup.md) and run `./scripts/verify-part-08.sh`.

**Hardware:** ≥25 GB free disk for kernel tree + build; ≥8 GB RAM (16 GB recommended for parallel builds).

**Safety:** Boot custom kernels in a VM only until you have a recovery plan. See [labs/part-08/checklists/vm-safety-checklist.md](../labs/part-08/checklists/vm-safety-checklist.md).

## Scope

| In this part | Deferred to Part 9 |
|---------------|---------------------|
...
Do not start Part 9 until you can independently:
...
- Complete all Part 8 projects (42–46) with written build/trace/patch artifacts

## Resources

See [resources/part-08.md](../resources/part-08.md) for the canonical reading list and pinned kernel version.

## Projects in This Part

| # | Project | Module | Spec |
|---|---------|--------|------|
| 42 | Kernel boot log analysis | 8.1 | [42-kernel-boot-log-analysis.md](../projects/part-08/42-kernel-boot-log-analysis.md) |
| 43 | Custom kernel build and VM boot | 8.2 | [43-custom-kernel-build-boot.md](../projects/part-08/43-custom-kernel-build-boot.md) |
| 44 | Syscall debug patch | 8.3 | [44-syscall-debug-patch.md](../projects/part-08/44-syscall-debug-patch.md) |
| 45 | MM or scheduler live trace | 8.4 | [45-mm-or-sched-trace.md](../projects/part-08/45-mm-or-sched-trace.md) |
| 46 | Part 8 capstone patch | 8.5 | [46-kernel-patch-capstone.md](../projects/part-08/46-kernel-patch-capstone.md) |

Set `KERNEL_SRC` to your local kernel tree (reuse Part 7 clone if present):
