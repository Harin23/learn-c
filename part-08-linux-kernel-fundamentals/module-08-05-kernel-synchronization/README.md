...
- Deliver a tested in-tree kernel patch as Part 8 capstone
...
Worksheet: [labs/part-08/worksheets/8.5-locking-scavenger-hunt.md](../../labs/part-08/worksheets/8.5-locking-scavenger-hunt.md)
...
Apply [kernel-patch-review-checklist.md](../../labs/part-08/checklists/kernel-patch-review-checklist.md) with focus on locking/context questions.
...
**Part 8 Capstone — Tested In-Tree Kernel Patch** — [projects/part-08/46-kernel-patch-capstone.md](../../projects/part-08/46-kernel-patch-capstone.md)
...
## Part 8 Oral Checklist (Self-Assessment)
...
Before advancing to Part 9, confirm:
...
- [ ] Part 8 oral checklist completed confidently
- [ ] [Part 8 exit gate](../README.md#part-exit-gate) fully satisfied

## Next Part

[Part 9 — Kernel Modules and Drivers](../../part-09-kernel-modules-drivers/)

Requires Part 8 exit gate complete.
