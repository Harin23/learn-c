...
- Run [labs/part-08/scripts/setup-kernel-build.sh](../../labs/part-08/scripts/setup-kernel-build.sh)
- Read [vm-safety-checklist.md](../../labs/part-08/checklists/vm-safety-checklist.md) before first boot

## Concepts to Study

1. **Kconfig** — `CONFIG_*` symbols; dependencies; `menuconfig` UI
2. **Kbuild** — recursive Makefiles; `obj-y`, `obj-m` (modules deferred to Part 9)
...
Reuse Part 7 clone or clone pinned tag from [resources/part-08.md](../../resources/part-08.md):
...
Worksheet: [labs/part-08/worksheets/8.2-kbuild-tour.md](../../labs/part-08/worksheets/8.2-kbuild-tour.md)
...
**Custom Kernel Build and VM Boot** — [projects/part-08/43-custom-kernel-build-boot.md](../../projects/part-08/43-custom-kernel-build-boot.md)

Template script: [labs/part-08/scripts/qemu-boot-test.sh.template](../../labs/part-08/scripts/qemu-boot-test.sh.template)
...
| [resources/part-08.md](../../resources/part-08.md) | VM setup notes |
