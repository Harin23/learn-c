...
Starter: [labs/phase-05/condvar_starter.c](../../labs/phase-05/condvar_starter.c)

### Lab 2: Bounded Queue with Mutex + Cond

Multiple producers/consumers in-process (Phase 4 ring buffer + cond vars).

### Lab 3: Thread Pool Skeleton

Complete starter with `tpool_submit` and `tpool_shutdown`.

Starter: [labs/phase-05/tpool_starter/](../../labs/phase-05/tpool_starter/)
...
**Thread Pool** — [projects/phase-05/29-thread-pool.md](../../projects/phase-05/29-thread-pool.md)
