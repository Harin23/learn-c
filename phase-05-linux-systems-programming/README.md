...
Deep dive into system calls, process creation, pipes, advanced threading, TCP/IP networking, and event-driven I/O. This phase bridges user-space applications to kernel interaction patterns used throughout Linux.
...
Complete the [Phase 4 exit gate](../phase-04-linux-user-space/README.md#phase-exit-gate) before starting.
...
Do not start Phase 6 or Phase 7 until you can independently:
...
- Complete all Phase 5 projects (27–33) with zero compiler warnings

## Resources

See [resources/phase-05.md](../resources/phase-05.md) for the canonical reading list.
