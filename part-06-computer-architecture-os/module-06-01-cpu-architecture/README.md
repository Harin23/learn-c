...
- Relate Part 2 stack frames to register and stack pointer usage in assembly
- Use `objdump`, `gcc -S`, and GDB `disassemble` confidently

## Prerequisites

- Completed [Part 5 exit gate](../../part-05-linux-systems-programming/README.md#part-exit-gate)
- Part 2 stack/heap module recommended
...
```bash
gcc -S -O0 -fno-omit-frame-pointer -o hello.s labs/part-06/hello.c
```
...
```bash
gcc -g -O0 -o hello labs/part-06/hello.c
...
Starter: [labs/part-06/add_regs.c](../../labs/part-06/add_regs.c)
...
**Assembly and Register Trace** — [projects/part-06/34-assembly-trace.md](../../projects/part-06/34-assembly-trace.md)
