...
- Connect Part 4 file I/O to kernel page cache behavior

## Prerequisites

- Completed [Module 6.3](../module-06-03-scheduling/README.md) exit criteria
- Part 4 file I/O projects
...
Starter: [labs/part-06/stat_compare_starter.sh](../../labs/part-06/stat_compare_starter.sh)
...
**Inode and Filesystem Lab** — [projects/part-06/37-inode-filesystem-lab.md](../../projects/part-06/37-inode-filesystem-lab.md)
...
|----------|-------|
| TLPI Ch. 14 | Files |
| Linux VFS documentation in kernel tree | Part 7 |
