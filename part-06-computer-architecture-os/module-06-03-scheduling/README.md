...
Starter: [labs/part-06/sched_fcfs_starter.c](../../labs/part-06/sched_fcfs_starter.c)
...
**CPU Scheduler Simulator** — [projects/part-06/36-scheduler-simulator.md](../../projects/part-06/36-scheduler-simulator.md)
...
| Linux kernel `kernel/sched/` | Part 7–8 reading target |
