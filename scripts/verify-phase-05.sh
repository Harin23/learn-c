#!/usr/bin/env bash
# Verify Phase 5 lab starters compile.
set -euo pipefail

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
LABS="$ROOT/labs/phase-05"
PASS=0
FAIL=0
...
echo "=== Phase 5 toolchain checks ==="
check_cmd gcc ""
check_cmd make ""
check_cmd strace strace

echo ""
echo "=== Compile Phase 5 lab starters ==="
...
echo "Environment ready for Phase 5."
