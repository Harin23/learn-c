#!/usr/bin/env bash
# Verify Phase 6 lab starters compile.
set -euo pipefail

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
LABS="$ROOT/labs/phase-06"
PASS=0
FAIL=0
...
echo "=== Phase 6 toolchain checks ==="
check_cmd gcc
check_cmd objdump

echo ""
echo "=== Compile Phase 6 lab starters ==="
...
echo "Environment ready for Phase 6."
