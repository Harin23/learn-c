...
- Compare CPU scheduling (Part 6) to GPU command submission conceptually
...
7. **Part 6 contrast** — CFS vs GPU hardware queues
...
Worksheet: [labs/part-10/worksheets/10.3-mesa-scheduling.md](../../labs/part-10/worksheets/10.3-mesa-scheduling.md)

### Lab 4: Written Comparison

Two paragraphs: Part 6 round-robin/ CFS vs GPU command queue scheduling (qualitative).

## Module Report

**Mesa/GPU Scheduling Path** — [projects/part-10/mesa-gpu-scheduling.md](../../projects/part-10/mesa-gpu-scheduling.md)
...
| Part 6 [Module 6.3](../../part-06-computer-architecture-os/module-06-03-scheduling/README.md) | CPU scheduling baseline |
