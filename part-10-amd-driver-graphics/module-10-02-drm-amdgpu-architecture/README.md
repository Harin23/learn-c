...
6. **PCI binding** — amdgpu as PCI driver (Part 9 connection)
...
Worksheet: [labs/part-10/worksheets/10.2-drm-amdgpu-tree.md](../../labs/part-10/worksheets/10.2-drm-amdgpu-tree.md)
...
### Lab 3: Compare to Part 7 VFS Trace

Two paragraphs: how opening `/dev/dri/card0` differs from opening a regular file (Part 7 Project 40).
...
**DRM/AMDGPU Architecture Walk** — [projects/part-10/drm-amdgpu-architecture.md](../../projects/part-10/drm-amdgpu-architecture.md)
...
| Part 7 [Project 40](../../projects/part-07/40-kernel-subsystem-trace.md) | Trace format |
